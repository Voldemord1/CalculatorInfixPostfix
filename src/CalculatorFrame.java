...
class CalculatorFrame extends JFrame implements ActionListener  {
    ...
    public String infixToPostfix(){
        ...
        String expression = jtfInfix.getText().replace("\u2217", "*");
    ...
    public String calculate() {
        Stack stack = new Stack<>();
        String[] postFix = jtfPostfix.getText().trim().split(" ");
        for(int i = 0; i < postFix.length; i++)
        {
            ...
            {
                int right = Integer.parseInt(stack.pop().toString());
                int left = Integer.parseInt(stack.pop().toString());
